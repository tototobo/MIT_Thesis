...
df1['Date'] = pd.to_datetime(df1['Time_Index'], unit='h', origin=pd.Timestamp('2016-01-01'))
df2['Date'] = pd.to_datetime(df2['Time_Index'], unit='h', origin=pd.Timestamp('2016-01-01'))
dfload['Date'] = pd.to_datetime(dfload['Time_Index'], unit='h', origin=pd.Timestamp('2016-01-01'))
...
file_path_IntGenbyFuel2016_hourly = os.path.join(script_directory, 'IntGenbyFuel2016_hourly.csv')

dfgenX = pd.read_csv(file_path_power)
dfgenE = pd.read_csv(file_path_IntGenbyFuel2016_hourly)
...
dfgenX['Date'] = pd.to_datetime(dfgenX['Time_Index'], unit='h', origin=pd.Timestamp('2016-01-01'))
dfgenE['Date'] = pd.to_datetime(dfgenE['Time_Index'], unit='h', origin=pd.Timestamp('2016-01-01'))

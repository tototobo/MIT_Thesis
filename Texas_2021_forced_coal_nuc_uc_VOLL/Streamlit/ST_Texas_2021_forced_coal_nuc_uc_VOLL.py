...
# set page title
st.title('Texas 2021 - Forced coal and nuclear generation, unit commitment, and Demand Response')

# add table with text
st.write('### Parameters')
param_table = pd.DataFrame()
param_table['Parameter'] = ['Year', 'Forced coal generation', 'Forced nuclear generation', 'Unit commitment', 'Demand Response', 'Energy share requirement']
param_table['Value'] = ['2021', '3k', 'Yes', 'Yes', 'Yes', 'No']
...
df1['Date'] = pd.to_datetime(df1['Time_Index'], unit='h', origin=pd.Timestamp('2021-01-01'))
df2['Date'] = pd.to_datetime(df2['Time_Index'], unit='h', origin=pd.Timestamp('2021-01-01'))
dfload['Date'] = pd.to_datetime(dfload['Time_Index'], unit='h', origin=pd.Timestamp('2021-01-01'))
...
dfgenX['Date'] = pd.to_datetime(dfgenX['Time_Index'], unit='h', origin=pd.Timestamp('2021-01-01'))
dfgenE['Date'] = pd.to_datetime(dfgenE['Time_Index'], unit='h', origin=pd.Timestamp('2021-01-01'))
